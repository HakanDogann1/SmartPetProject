...
namespace SmartPetProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20250531071206_mig1_appointment_update")]
    partial class mig1_appointment_update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPetProject.EntityLayer.Entities.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SmartPetProject.EntityLayer.Entities.Message", b =>
                {
                    b.HasOne("SmartPetProject.EntityLayer.Entities.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartPetProject.EntityLayer.Entities.ApplicationUser", "Sender")
                        .WithMany()
